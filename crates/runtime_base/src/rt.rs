...
pub static SUPERVISOR: Lazy<tokio::runtime::Runtime> = Lazy::new(|| {
...
// are saturated.
pub static PRIMARY_WORKER: Lazy<tokio_util::task::LocalPoolHandle> = Lazy::new(|| {
...
pub static USER_WORKER: Lazy<tokio_util::task::LocalPoolHandle> = Lazy::new(|| {
